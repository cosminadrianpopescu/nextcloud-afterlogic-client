...
class BaseComponent extends BaseClass {
    ...
    alert(title, message, severity = 'success', sticky = false) {
...
/* harmony import */ var _services_settings__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../services/settings */ "./src/ts/services/settings.ts");
/* harmony import */ var _nextcloud_nextcloud__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../nextcloud/nextcloud */ "./src/ts/nextcloud/nextcloud.ts");
...
let Attachments = class Attachments extends _base__WEBPACK_IMPORTED_MODULE_4__["BaseComponent"] {
    ...
    _doDownload(a, where, preview = false) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this._attDownloading = true;
            const fileName = this.message ? `${this.message.Uid}-${a.FileName}` : a.FileName;
            const result = yield this._api.downloadAttachment(this.account, a, fileName, where, this.message, preview);
            this._attDownloading = false;
            return result;
        });
    }
    ...
    _viewAttachment(a) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const result = yield this._doDownload(a, _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["FilesystemDirectory"].Documents, true);
            if (result == null) {
                return;
            }
    ...
    _uploadToCloud(att) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const folder = yield this._nc.pickFolder(this._platform.is('android'));
            if (!folder) {
                return;
            }
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_5__["NgInject"])(_nextcloud_nextcloud__WEBPACK_IMPORTED_MODULE_9__["Nextcloud"])
], Attachments.prototype, "_nc", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_5__["NgInject"])(_services_mails__WEBPACK_IMPORTED_MODULE_7__["Mails"])
], Attachments.prototype, "_mails", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_5__["NgInject"])(_services_settings__WEBPACK_IMPORTED_MODULE_8__["Settings"])
], Attachments.prototype, "_settings", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_5__["NgInject"])(_ionic_angular__WEBPACK_IMPORTED_MODULE_10__["Platform"])
], Attachments.prototype, "_platform", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _nextcloud_nextcloud__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../nextcloud/nextcloud */ "./src/ts/nextcloud/nextcloud.ts");
...
let Compose = class Compose extends _base__WEBPACK_IMPORTED_MODULE_4__["BaseComponent"] {
    ...
    _waitEditorReady() {
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["interval"])(100).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeWhile"])(() => !this._editor), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])(() => {
    ...
    _cloudAttach() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const files = yield this._nc.pickFile(this._platform.is('android'));
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_5__["NgInject"])(_nextcloud_nextcloud__WEBPACK_IMPORTED_MODULE_13__["Nextcloud"])
], Compose.prototype, "_nc", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_5__["NgInject"])(_ionic_angular__WEBPACK_IMPORTED_MODULE_14__["Platform"])
], Compose.prototype, "_platform", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
let Message = class Message extends _base__WEBPACK_IMPORTED_MODULE_5__["BaseComponent"] {
    ...
    _transform() {
        ...
        const div = this._body.nativeElement.querySelector('*');
        div.setAttribute('style', '');
        setTimeout(() => div.setAttribute('style', _services_utils__WEBPACK_IMPORTED_MODULE_11__["Utils"].transformMessageBody(this._width, div)));
    }
    _initMe() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_6__["NgInject"])(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"])
], Message.prototype, "_zone", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _services_settings__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../services/settings */ "./src/ts/services/settings.ts");
/* harmony import */ var _services_utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../services/utils */ "./src/ts/services/utils.ts");
/* harmony import */ var _services_store__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../services/store */ "./src/ts/services/store.ts");
...
let MessagesList = class MessagesList extends _base__WEBPACK_IMPORTED_MODULE_4__["BaseComponent"] {
    ...
    _initSubscriptions() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const f = yield this._store.getFolderSearch();
            this._account$ = this._mails.currentAccount$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(account => {
                const result = _services_utils__WEBPACK_IMPORTED_MODULE_11__["Utils"].folderById(account.FoldersOrder, f);
                this._search.folder = result ? result.Id : null;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(account => !!account));
            ...
            this._search.folder = yield this._store.getFolderSearch();
    ...
    _fetch(first, auto = false) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const [txt, searchFolder] = _services_utils__WEBPACK_IMPORTED_MODULE_11__["Utils"].searchFolder(this._search.simple);
            const id = searchFolder || this._folder.Id;
            let [err, result] = yield Object(_models__WEBPACK_IMPORTED_MODULE_6__["to"])(this._api.getMessages(this.account, id, first, this._pageSize, txt, '', auto));
            if (err) {
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_5__["NgInject"])(_services_store__WEBPACK_IMPORTED_MODULE_12__["Store"])
], MessagesList.prototype, "_store", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('all', { static: false })
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ALL_MAIL", function() { return ALL_MAIL; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var _nextcloud_nextcloud__WEBPACK_IMPORTED_MODULE_57__ = __webpack_require__(/*! ../nextcloud/nextcloud */ "./src/ts/nextcloud/nextcloud.ts");
/* harmony import */ var primeng_dynamicdialog__WEBPACK_IMPORTED_MODULE_58__ = __webpack_require__(/*! primeng/dynamicdialog */ "./node_modules/primeng/__ivy_ngcc__/fesm2015/primeng-dynamicdialog.js");
/* harmony import */ var _nextcloud_webdav__WEBPACK_IMPORTED_MODULE_59__ = __webpack_require__(/*! ../nextcloud/webdav */ "./src/ts/nextcloud/webdav.ts");
/* harmony import */ var _nextcloud_filepick__WEBPACK_IMPORTED_MODULE_60__ = __webpack_require__(/*! ../nextcloud/filepick */ "./src/ts/nextcloud/filepick.ts");
/* harmony import */ var ngx_pinch_zoom__WEBPACK_IMPORTED_MODULE_61__ = __webpack_require__(/*! ngx-pinch-zoom */ "./node_modules/ngx-pinch-zoom/__ivy_ngcc__/fesm2015/ngx-pinch-zoom.js");
/* harmony import */ var primeng_splitbutton__WEBPACK_IMPORTED_MODULE_62__ = __webpack_require__(/*! primeng/splitbutton */ "./node_modules/primeng/__ivy_ngcc__/fesm2015/primeng-splitbutton.js");
...
Main = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _nextcloud_filepick__WEBPACK_IMPORTED_MODULE_60__["Filepick"], _pipes__WEBPACK_IMPORTED_MODULE_45__["HasArchive"], _pipes__WEBPACK_IMPORTED_MODULE_45__["FoldersFlatList"], _pipes__WEBPACK_IMPORTED_MODULE_45__["IsOfType"],
        ],
        ...
        imports: [
            ...
            primeng_dynamicdialog__WEBPACK_IMPORTED_MODULE_58__["DynamicDialogModule"], ngx_pinch_zoom__WEBPACK_IMPORTED_MODULE_61__["PinchZoomModule"], primeng_splitbutton__WEBPACK_IMPORTED_MODULE_62__["SplitButtonModule"],
        ],
        providers: [
            _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_9__["StatusBar"], _services_settings__WEBPACK_IMPORTED_MODULE_54__["Settings"],
            _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_8__["SplashScreen"], _services_api__WEBPACK_IMPORTED_MODULE_47__["Api"], _services_contacts__WEBPACK_IMPORTED_MODULE_48__["Contacts"], _services_layout__WEBPACK_IMPORTED_MODULE_50__["Layout"], _services_navigation__WEBPACK_IMPORTED_MODULE_52__["Navigation"], _services_store__WEBPACK_IMPORTED_MODULE_55__["Store"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FilepickInstance", function() { return FilepickInstance; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Filepick", function() { return Filepick; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../base */ "./src/ts/base.ts");
/* harmony import */ var _decorators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../decorators */ "./src/ts/decorators.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils */ "./src/ts/nextcloud/utils.ts");
/* harmony import */ var _webdav__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./webdav */ "./src/ts/nextcloud/webdav.ts");
...
class FilepickInstance {
}
let Filepick = class Filepick extends _base__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor() {
        super();
        this.path = '/';
        this.type = 'file';
        this.choose = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this._loading = true;
        this._files = [];
        this._selection = [];
    ...
    _results(files) {
        const result = files.map(f => _utils__WEBPACK_IMPORTED_MODULE_4__["NextcloudUtils"].toTreeNode(f, this.type == 'file'));
        if (this.type == 'file') {
            return result;
        }
    ...
    _load(node) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const path = node ? node.data.filename : this.path;
            this._loading = true;
            const result = yield this._webdav.getFiles(path);
            if (!node) {
    ...
    _choose() {
        ...
        this.choose.emit(selection.map((n) => n.data).filter((f) => f.type == this.type));
        // this.choose.emit(this._selection.map(n => n.data));
    }
};
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], Filepick.prototype, "path", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], Filepick.prototype, "type", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], Filepick.prototype, "choose", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_3__["NgInject"])(_webdav__WEBPACK_IMPORTED_MODULE_5__["Webdav"])
], Filepick.prototype, "_webdav", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_3__["NgCycle"])('init')
], Filepick.prototype, "_initMe", null);
Filepick = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'nc-filepick',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./filepick.html */ "./node_modules/raw-loader/dist/cjs.js!./src/ts/nextcloud/filepick.html")).default,
        encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./filepick.scss */ "./src/ts/nextcloud/filepick.scss")).default]
    })
], Filepick);
...
/* harmony import */ var _models__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models */ "./src/ts/nextcloud/models.ts");
...
class FilePicker {
    ...
    static get credentials() {
        const result = new _models__WEBPACK_IMPORTED_MODULE_2__["NextcloudCredentials"]();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NextcloudPoll", function() { return NextcloudPoll; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NextcloudLogin", function() { return NextcloudLogin; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NextcloudCredentials", function() { return NextcloudCredentials; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NextcloudItem", function() { return NextcloudItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NextcloudShare", function() { return NextcloudShare; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NextcloudShareResult", function() { return NextcloudShareResult; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _decorators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../decorators */ "./src/ts/decorators.ts");
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_1__["deserialize"])(NextcloudPoll)
], NextcloudLogin.prototype, "poll", void 0);
class NextcloudCredentials {
}
class NextcloudItem {
}
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_1__["deserialize"])(Date)
], NextcloudItem.prototype, "lastmod", void 0);
class NextcloudShare {
}
class NextcloudShareResult {
}
...
/* harmony import */ var _decorators__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../decorators */ "./src/ts/decorators.ts");
/* harmony import */ var _models__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../models */ "./src/ts/models.ts");
/* harmony import */ var _filepicker__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./filepicker */ "./src/ts/nextcloud/filepicker.ts");
/* harmony import */ var _models__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./models */ "./src/ts/nextcloud/models.ts");
/* harmony import */ var _webdav__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./webdav */ "./src/ts/nextcloud/webdav.ts");
/* harmony import */ var _filepick__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./filepick */ "./src/ts/nextcloud/filepick.ts");
...
let Nextcloud = Nextcloud_1 = class Nextcloud extends _base__WEBPACK_IMPORTED_MODULE_3__["BaseClass"] {
    constructor() {
        super();
        this._lastPath = '/';
        this._credentials = null;
    }
    _rest(url, options, type) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (!options) {
                options = {};
            }
            ...
            return _models__WEBPACK_IMPORTED_MODULE_5__["ModelFactory"].instance(json, type);
        });
    }
    static get isOC() {
    ...
    _pickFromFrame() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const picker = new _filepicker__WEBPACK_IMPORTED_MODULE_6__["FilePicker"]('Choose a file', true, [], true, 1, false, this._lastPath);
            const result = yield picker.pick();
            yield this._processLastPath(result);
            return result;
        });
    }
    _pickFromApp(maximized, type = 'file') {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const options = {
            ...
            const ref = this._modal.open(_filepick__WEBPACK_IMPORTED_MODULE_9__["Filepick"], options);
            yield new Promise(resolve => setTimeout(resolve));
            _filepick__WEBPACK_IMPORTED_MODULE_9__["FilepickInstance"].instance.type = type;
            return new Promise(resolve => {
                _filepick__WEBPACK_IMPORTED_MODULE_9__["FilepickInstance"].instance.choose.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["take"])(1)).subscribe(files => {
                    resolve(files.map(f => f.filename));
                    ref.close();
                });
                ref.onDestroy.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["take"])(1)).subscribe(() => resolve([]));
            });
        });
    }
    pickFile(maximized = false) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (this._isNcSetup) {
    ...
    _pickFolderOC() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const picker = new _filepicker__WEBPACK_IMPORTED_MODULE_6__["FilePicker"]('Choose a folder', false, ['*.zzz'], true, 1, true, this._lastPath);
            const result = yield picker.pick();
            yield this._processLastPath([result]);
            return result;
        });
    }
    _pickFolderNc(maximized) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const result = yield this._pickFromApp(maximized, 'directory');
            return result[0];
        });
    }
    pickFolder(maximized = false) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (this._isNcSetup) {
    ...
    _downloadOC(path) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const content = yield fetch(`${_filepicker__WEBPACK_IMPORTED_MODULE_6__["FilePicker"].basePath}/${path}`);
    ...
    upload(path, content) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (this._isNcSetup) {
                yield this._webdav.upload(path, content);
                return path;
            }
            return _filepicker__WEBPACK_IMPORTED_MODULE_6__["FilePicker"].upload(path, content);
        });
    }
    _poll(poll, n = 0) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const [err, result] = yield Object(_models__WEBPACK_IMPORTED_MODULE_5__["to"])(this._rest(poll.endpoint, { method: 'post', body: `token=${poll.token}` }, _models__WEBPACK_IMPORTED_MODULE_7__["NextcloudCredentials"]));
            if (err) {
    ...
    login(baseUrl) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const loginData = yield this._rest(`${baseUrl}/index.php/login/v2`, { method: 'post' }, _models__WEBPACK_IMPORTED_MODULE_7__["NextcloudLogin"]);
    ...
    mkdir(path) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return yield this._webdav.mkdir(path);
        });
    }
    exists(path) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            return _filepicker__WEBPACK_IMPORTED_MODULE_6__["FilePicker"].exists(path);
        });
    }
    _shareDate() {
        const d = new Date();
    ...
    share(path) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const result = yield this._rest(`${c.server}/ocs/v2.php/apps/files_sharing/api/v1/shares`, options, _models__WEBPACK_IMPORTED_MODULE_7__["NextcloudShareResult"]);
    ...
    unshare(id) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            return this._rest(`${c.server}/ocs/v2.php/apps/files_sharing/api/v1/shares/${id}`, options, Object);
        });
    }
};
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_4__["NgInject"])(primeng_dynamicdialog__WEBPACK_IMPORTED_MODULE_2__["DialogService"])
], Nextcloud.prototype, "_modal", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_4__["NgInject"])(_webdav__WEBPACK_IMPORTED_MODULE_8__["Webdav"])
], Nextcloud.prototype, "_webdav", void 0);
Nextcloud = Nextcloud_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
class Storage {
    static get(arg) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const response = yield fetch(`${Storage._url}/${arg.key}`);
    ...
    static set(arg) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield fetch(`${Storage._url}`, { method: 'POST', body: data });
        });
    }
}
Storage._baseUrl = window.location.href.replace(/^(.*)\/js(\/index.html)?.*$/, '$1');
Storage._url = `${Storage._baseUrl}/api/0.1/store`;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NextcloudUtils", function() { return NextcloudUtils; });
class NextcloudUtils {
    ...
    static toTreeNode(src, forFiles = true) {
        return {
            label: src.basename,
            leaf: src.type == 'file',
            data: src,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Webdav", function() { return Webdav; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../base */ "./src/ts/base.ts");
/* harmony import */ var webdav_web__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! webdav/web */ "./node_modules/webdav/web/index.js");
/* harmony import */ var webdav_web__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(webdav_web__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
/* harmony import */ var _models__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../models */ "./src/ts/models.ts");
/* harmony import */ var _models__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./models */ "./src/ts/nextcloud/models.ts");
...
let Webdav = class Webdav extends _base__WEBPACK_IMPORTED_MODULE_2__["BaseClass"] {
    constructor() {
        super(...arguments);
        this._client = null;
        this._ready$ = new rxjs__WEBPACK_IMPORTED_MODULE_4__["ReplaySubject"](1);
    }
    init(credentials) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (!credentials) {
            ...
            this._client = Object(webdav_web__WEBPACK_IMPORTED_MODULE_3__["createClient"])(`${credentials.server}/remote.php/dav/files/${credentials.loginName}`, {
    ...
    getFiles(path) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield new Promise(resolve => this._ready$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["take"])(1)).subscribe(resolve));
            const result = yield this._client.getDirectoryContents(path);
            result.sort((a, b) => {
                if (a.type == b.type) {
            ...
            return _models__WEBPACK_IMPORTED_MODULE_5__["ModelFactory"].instance(result, _models__WEBPACK_IMPORTED_MODULE_6__["NextcloudItem"]);
        });
    }
    download(path) {
    ...
    upload(path, content) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this._client.putFileContents(path, content, { overwrite: true });
        });
    }
    mkdir(path) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
...
Webdav = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
], Webdav);
...
/* harmony import */ var _services_settings__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../services/settings */ "./src/ts/services/settings.ts");
/* harmony import */ var _services_utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../services/utils */ "./src/ts/services/utils.ts");
/* harmony import */ var _services_navigation__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../services/navigation */ "./src/ts/services/navigation.ts");
...
let Home = class Home extends _base__WEBPACK_IMPORTED_MODULE_4__["BaseComponent"] {
    ...
    _initMe() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const server = yield this._settings.getServer();
            const theme = yield this._settings.getTheme();
    ...
    _actionIcon(which) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.showLoading();
            yield Object(_models__WEBPACK_IMPORTED_MODULE_6__["to"])(this._action(which));
            if (this._message) {
                this._toolbarBack();
            }
            this.hideLoading();
    ...
    _action(which) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            if (which == 'archive') {
                [err,] = yield Object(_models__WEBPACK_IMPORTED_MODULE_6__["to"])(this._api.archive(this._account, this._folder, arr));
            }
            if (err) {
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_5__["NgInject"])(_services_navigation__WEBPACK_IMPORTED_MODULE_13__["Navigation"])
], Home.prototype, "_nav", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _services_mails__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../services/mails */ "./src/ts/services/mails.ts");
/* harmony import */ var _nextcloud_nextcloud__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../nextcloud/nextcloud */ "./src/ts/nextcloud/nextcloud.ts");
...
let Settings = class Settings extends _base__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    ...
    _nextcloudLogin() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.showLoading();
            const [err, result] = yield Object(_models__WEBPACK_IMPORTED_MODULE_4__["to"])(this._nc.login(this._model.nextcloudUrl));
            if (err) {
                console.error(err);
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_3__["NgInject"])(_nextcloud_nextcloud__WEBPACK_IMPORTED_MODULE_10__["Nextcloud"])
], Settings.prototype, "_nc", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_3__["NgCycle"])('init')
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NcFilesToTree", function() { return NcFilesToTree; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HasArchive", function() { return HasArchive; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FoldersFlatList", function() { return FoldersFlatList; });
...
let NcFilesToTree = class NcFilesToTree extends _base__WEBPACK_IMPORTED_MODULE_5__["BaseClass"] {
    transform(files) {
        return files.map(f => ({
            label: f.basename,
            leaf: f.type == 'file',
...
NcFilesToTree = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({ name: 'ncFilesToTree' })
], NcFilesToTree);
...
let HasArchive = class HasArchive extends _base__WEBPACK_IMPORTED_MODULE_5__["BaseClass"] {
    _search(folders) {
        if (folders.length == 0) {
            return false;
        }
        const f = folders.find(f => f.Id == _models__WEBPACK_IMPORTED_MODULE_7__["ALL_MAIL"]);
        if (f) {
            return true;
        }
        return this._search(folders.map(f => f.SubFolders).reduce((acc, v) => acc.concat(v), []));
    }
    transform(a, folderId) {
...
HasArchive = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({ name: 'hasArchive' })
], HasArchive);

let FoldersFlatList = class FoldersFlatList extends _base__WEBPACK_IMPORTED_MODULE_5__["BaseClass"] {
    transform(account) {
        return account.Folders$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(folders => {
            if (!Array.isArray(folders)) {
                return [];
            }
            const result = [{ value: '', label: 'Current folder' }];
            result.push(..._services_utils__WEBPACK_IMPORTED_MODULE_9__["Utils"].foldersFlatList2(folders).map(f => ({ value: f.Id, label: account.AccountID == _models__WEBPACK_IMPORTED_MODULE_7__["COMBINED_ACCOUNT_ID"] ? f.Name : f.Id })));
            return result;
        }));
    }
};
FoldersFlatList = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({ name: 'foldersFlatList' })
], FoldersFlatList);

let IsOfType = class IsOfType extends _base__WEBPACK_IMPORTED_MODULE_5__["BaseClass"] {
    transform(x, type) {
        console.log('analyze', x, type, typeof (x));
        return typeof (x) == type;
    }
};
IsOfType = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({ name: 'isOfType' })
], IsOfType);
...
/* harmony import */ var _nextcloud_nextcloud__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../nextcloud/nextcloud */ "./src/ts/nextcloud/nextcloud.ts");
var Api_1;
...
let Api = Api_1 = class Api extends _base__WEBPACK_IMPORTED_MODULE_7__["BaseClass"] {
    constructor() {
        super();
    ...
    // Patched
    downloadUrl(account, url, fileName, where, msg, preview = false) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this._checkReady();
            if (msg) {
            ...
            if (preview && this._nc.isNextcloud) {
                const basePath = '/tmp';
                if (!(yield this._nc.exists(basePath))) {
                    const [err,] = yield Object(_models__WEBPACK_IMPORTED_MODULE_9__["to"])(this._nc.mkdir(basePath));
                    if (err) {
                ...
                const [err,] = yield Object(_models__WEBPACK_IMPORTED_MODULE_9__["to"])(this._nc.upload(path, fileData));
                if (err) {
                    console.error('Path is', path);
                    throw `ERROR_UPLOADING_FOR_PREVIEW`;
                }
                const [shareErr, share] = yield Object(_models__WEBPACK_IMPORTED_MODULE_9__["to"])(this._nc.share(path));
                if (shareErr) {
    ...
    // Patched
    downloadAttachment(account, att, fileName, where, msg, preview = false) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this._checkReady();
    ...
    archive(account, folder, messages) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return this.moveMessages(account, folder, _models__WEBPACK_IMPORTED_MODULE_9__["ALL_MAIL"], messages);
        });
    }
    // Patched
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_8__["NgInject"])(_nextcloud_nextcloud__WEBPACK_IMPORTED_MODULE_12__["Nextcloud"])
], Api.prototype, "_nc", void 0);
Api = Api_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
], Api);
...
let Navigation = class Navigation extends _base__WEBPACK_IMPORTED_MODULE_5__["BaseClass"] {
    constructor() {
        ...
        this.backButton$ = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_6__["NgInject"])(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"])
], Navigation.prototype, "_zone", void 0);
...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./store */ "./src/ts/services/store.ts");
/* harmony import */ var _models__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../models */ "./src/ts/models.ts");
/* harmony import */ var _nextcloud_models__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../nextcloud/models */ "./src/ts/nextcloud/models.ts");
/* harmony import */ var _nextcloud_nextcloud__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../nextcloud/nextcloud */ "./src/ts/nextcloud/nextcloud.ts");
...
let Settings = class Settings extends _base__WEBPACK_IMPORTED_MODULE_2__["BaseClass"] {
    ...
    _initNextcloud() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const c = yield this.getNextcloudLogin();
            if (!c) {
                return;
            }
    ...
    getCloudPreview() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const result = yield this._store.load(CLOUD_PREVIEW);
            if (result == null) {
                return false;
            }
            return result;
    ...
    setCloudPreview(x) { return this._store.save(CLOUD_PREVIEW, x); }
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_decorators__WEBPACK_IMPORTED_MODULE_3__["NgInject"])(_nextcloud_nextcloud__WEBPACK_IMPORTED_MODULE_7__["Nextcloud"])
], Settings.prototype, "_nc", void 0);
Settings = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
], Settings);
...
/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../base */ "./src/ts/base.ts");
/* harmony import */ var _models__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../models */ "./src/ts/models.ts");
/* harmony import */ var _nextcloud_nextcloud__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../nextcloud/nextcloud */ "./src/ts/nextcloud/nextcloud.ts");
/* harmony import */ var _nextcloud_storage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../nextcloud/storage */ "./src/ts/nextcloud/storage.ts");
...
const Storage = _nextcloud_nextcloud__WEBPACK_IMPORTED_MODULE_5__["Nextcloud"].isOC ? _nextcloud_storage__WEBPACK_IMPORTED_MODULE_6__["Storage"] : _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Plugins"].Storage;
...
let Store = class Store extends _base__WEBPACK_IMPORTED_MODULE_3__["BaseClass"] {
    ...
    getFolderSearch() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return this.load(FOLDER_SEARCH);
        });
    }
    setFolderSearch(f) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
...
class Utils {
    ...
    static foldersFlatList2(folders) {
        const result = [];
        folders.forEach(f => {
            result.push(f);
    ...
    static transformMessageBody(clientWidth, el) {
