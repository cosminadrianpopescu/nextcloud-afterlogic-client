...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("body {\n  overflow: hidden;\n}\n\napp-home #container {\n  text-align: center;\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 50%;\n  transform: translateY(-50%);\n}\n\napp-home #container strong {\n  font-size: 20px;\n  line-height: 26px;\n}\n\napp-home #container p {\n  font-size: 16px;\n  line-height: 22px;\n  color: #8c8c8c;\n  margin: 0;\n}\n\napp-home #container a {\n  text-decoration: none;\n}\n\napp-home .folders-col {\n  width: 200px;\n  max-width: 300px;\n}\n\napp-home .mails-col {\n  width: 400px;\n}\n\napp-home .mails-col button {\n  margin-left: 10px;\n}\n\napp-home .mails-col .left {\n  float: left;\n}\n\napp-home .right {\n  float: right;\n}\n\napp-home .menuWidth {\n  min-width: 300px;\n  text-align: left;\n}\n\napp-home .mail-col {\n  width: calc(100% - 600px);\n}\n\napp-home .top td {\n  vertical-align: top;\n  overflow-y: auto;\n}\n\napp-home .messages-wrapper {\n  overflow-y: hidden;\n}\n\napp-home .wrapper {\n  height: calc(100vh - 48px);\n  overflow-y: auto;\n}\n\napp-home al-messages-list .ui-table-wrapper {\n  height: calc(100vh - 97px);\n  overflow-y: auto;\n}\n\napp-home al-messages-list.mobile .ui-table-wrapper {\n  width: calc(100% - 8px);\n  padding-left: 9px;\n  overflow-x: hidden;\n  height: calc(100vh - 81px);\n}\n\napp-home .mobile-messages-list {\n  position: relative;\n  top: 8px;\n}\n\napp-home .w100 {\n  width: 100%;\n}\n\napp-home .padding-10 {\n  padding-left: 10px;\n  padding-right: 10px;\n}\n\napp-home .ui-toolbar-group-left i {\n  margin-left: 30px;\n  font-size: 30px;\n}\n\napp-home .ui-toolbar-group-left {\n  margin-left: -30px;\n}\n\napp-home [hidden] {\n  display: none !important;\n}\n\napp-home .ui-sidebar {\n  height: 100vh;\n  overflow-y: auto;\n}\n\napp-home .disabled {\n  opacity: 0.2;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("al-message {\n  /*.ui-overlaypanel {\n    top: 150px !important;\n    left: 370px !important;\n  }*/\n}\nal-message .p-grid.ui-fluid {\n  width: 100%;\n}\nal-message .center {\n  text-align: center;\n}\nal-message .from {\n  display: flex;\n  align-items: center;\n}\nal-message .margin {\n  margin-left: 10px;\n}\nal-message .buttons {\n  text-align: right;\n}\nal-message .buttons button {\n  margin-left: 4px;\n}\nal-message .avatar {\n  max-width: 56px;\n  margin: 8px;\n}\nal-message .details {\n  flex: 1;\n  margin-top: 11px;\n}\nal-message .actions {\n  max-width: 102px;\n  margin-top: 11px;\n}\nal-message .actions .fa {\n  font-size: 30px;\n  margin-left: 20px;\n}\nal-message .p-col-1 {\n  align-items: center;\n  display: flex;\n  justify-content: flex-end;\n}\nal-message .extra {\n  color: blue;\n}\nal-message .extra-details {\n  font-size: 0.8em;\n}\nal-message .contact-detail {\n  margin-right: 5px;\n}\nal-message .menu-options i {\n  margin-right: 10px;\n}\nal-message .max-width {\n  max-width: 150px;\n}\nal-message .message-body {\n  overflow-x: overlay;\n}\nal-message .hide-quote blockquote {\n  display: none;\n}\nal-message .main-container {\n  padding-left: 15px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let Compose = class Compose extends _base__WEBPACK_IMPORTED_MODULE_4__["BaseComponent"] {
    ...
    _initMe() {
        ...
        this._incloud = _services_nextcloud__WEBPACK_IMPORTED_MODULE_13__["Nextcloud"].isNextcloud();
    }
    _setModel() {
    ...
    _attach() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const attachments = yield Promise.all(p);
    ...
    _cloudAttach() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const files = yield _services_nextcloud__WEBPACK_IMPORTED_MODULE_13__["Nextcloud"].pickFile();
...
Main = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            _ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_7__["HTTP"], _ionic_native_file_chooser_ngx__WEBPACK_IMPORTED_MODULE_6__["FileChooser"], _services_background__WEBPACK_IMPORTED_MODULE_56__["Background"],
...
let Api = class Api extends _base__WEBPACK_IMPORTED_MODULE_7__["BaseClass"] {
    ...
    downloadUrl(account, url, fileName, where, msg) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            if (this._platform.is('desktop')) {
                const bin = yield data.blob();
                const buf = yield bin.arrayBuffer();
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _filepicker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./filepicker */ "./src/ts/services/filepicker.ts");
...
class Nextcloud {
    ...
    static pickFile() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const picker = new _filepicker__WEBPACK_IMPORTED_MODULE_1__["FilePicker"]('Choose a file', true, [], true, 1, false, Nextcloud._lastPath);
            const result = picker.pick();
            if (result.length > 0) {
                Nextcloud._lastPath = result[0].replace(/^(.*)\/[^\/]+$/g, '$1');
            }
            return result;
        });
    }
